...
/**
 * 仮想パラメータを表現するためのバリューオブジェクト。今所 LangDoc へ情報を記載するためだけに使用します。
 */
public class BlancoCgVirtualParameter {
    /**
    ...
    public String toString() {
        ...
        buf.append("blanco.cg.valueobject.BlancoCgVirtualParameter[");
     ...
     */
    public void copyTo(final BlancoCgVirtualParameter target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoCgVirtualParameter#copyTo(target): argument 'target' is null");
        }
