    ...
    private void expandExtendClassList(final BlancoCgClass cgClass,
        ...
        for (int index = 0; index < cgClass.getExtendClassList().size(); index++) {
            ...
            if (index == 0) {
                ...
                // TODO: Performs a check to see if the inheritance in VB.NET is a one-time event.
                // throw new
                // IllegalArgumentException("In the VB.NET, inheritance can only be performed once.");
