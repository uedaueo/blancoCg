...
class BlancoCgSourceFilePythonSourceExpander {
    ...
    public List<java.lang.String> transformSourceFile(
        ...
        // throw new IllegalArgumentException("The list of interfaces has been given a value of type ["
        // + objClass.getClass().getName() + "] other than interface.");
        // }
    ...
    private void expandSourceFileHeader() {
        // TODO: Generates the source with cp932 decision.
