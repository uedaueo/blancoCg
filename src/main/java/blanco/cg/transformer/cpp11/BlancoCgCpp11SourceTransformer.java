 ...
 * This transformer converts a value object into C++11 source code.
 * 
 * @author IGA Tosiki
 */
public class BlancoCgCpp11SourceTransformer extends
    ...
    /**
     * Converts the source file value object to C++11 source code and outputs it to the writer.
     * 
     ...
     * 
     * The *.h is handled separately from this.
     * 
