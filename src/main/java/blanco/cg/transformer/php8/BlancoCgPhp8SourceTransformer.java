...
import blanco.cg.transformer.AbstractBlancoCgPhp8StyleTransformer;
 ...
 * This transformer converts a value object into PHP source code.
 *
 * @author IGA Tosiki
 */
public class BlancoCgPhp8SourceTransformer extends
        AbstractBlancoCgPhp8StyleTransformer {

    /**
     * Converts the source file value object to PHP source code and outputs it to the writer.
     *
    ...
    public void transform(final BlancoCgSourceFile argSourceFile,
        ...
        final List<java.lang.String> sourceLines = new BlancoCgSourceFilePhp8SourceExpander()
